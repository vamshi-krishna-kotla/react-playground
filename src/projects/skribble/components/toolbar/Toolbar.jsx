...
function ToolbarComponent({ eraserModeRef, pencilColorRef, pencilThicknessRef, eraserThicknessRef, cursorStyleRef }) {
    ...
    cursorStyleRef.current = `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" ${cursorColor} height="${width}" viewBox="0 0 ${width} ${width}" width="${width}"><circle cx="${widthHalf}" cy="${widthHalf}" r="${widthHalf}" ${cursorColor} /></svg>') ${widthHalf} ${widthHalf}, auto`;
